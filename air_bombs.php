                ...
                <div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
                    <div class="row">
                        ...
                        function getAll($table)
                        {
                            ...
                            $uid = $row["id"];
                            $query = "SELECT WNAME,PRICE,IMG_NAME1 FROM $table AS W , manufacturing_company_weapon AS mcw, weapons_images as WI WHERE W.WID=mcw.WID and mcw.WID=WI.WID and (W.WSUBCATEGORY = 'AIR LAUNCHED BOMBS')";
