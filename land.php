                ...
                <div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
                    <div class="row">
                        ...
                        function getAll($table)
                        {
                            ...
                            $uid = $row["id"];
                            $query = "SELECT WNAME,PRICE,IMG_NAME1 FROM $table AS W , manufacturing_company_weapon AS mcw, weapons_images as WI WHERE W.WID=mcw.WID and mcw.WID=WI.WID and (W.WSUBCATEGORY = 'PISTOLS' OR W.WSUBCATEGORY = 'MACHINE GUN')";
                                ...
                                <div class="col-lg-4 col-sm-6">
                                    <div class="product-item">
                                        <div class="pi-pic">
                                            ...
                                            <div class="pi-links">
                                                <!-- <a href="cart.php" class="add-card"><img src="dealer_icon/bag.png" alt=""></i><span>ADD TO CART</span></a> -->
                                            </div>
                                        </div>
                                        <div class="pi-text">
                                            <h6>$<?= $item['PRICE']; ?></h6>
