                ...
                <div class="col-lg-3 order-2 order-lg-1">
                    <div class="filter-widget">
                        ...
                        <ul class="category-menu">
                            <li><a href="#">Airforce Weapons</a>
                                <ul class="sub-menu">
                                    <li><a href="air.php">All <span>(2)</span></a></li>
                                    <li><a href="air_bombs.php">Bombs<span>(56)</span></a></li>
                                    <li><a href="air_rockets.php">Rockets<span>(56)</span></a></li>
                ...
                <div class="col-lg-9  order-1 order-lg-2 mb-5 mb-lg-0">
                    <div class="row">
                        ...
                        function getAll($table)
                        {
                            ...
                            $uid = $row["id"];
                            $query = "SELECT WNAME,PRICE,IMG_NAME1 FROM $table AS W , manufacturing_company_weapon AS mcw, weapons_images as WI WHERE W.WID=mcw.WID and mcw.WID=WI.WID and (W.WSUBCATEGORY = 'AIR LAUNCHED BOMBS' OR W.WSUBCATEGORY = 'AIR LAUNCHED ROCKETS')";
